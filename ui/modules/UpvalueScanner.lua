...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Hydroxide's Upvalue Scanner: https://github.com/CandyWirus/Hydroxide

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/CandyWirus/Hydroxide/revision/ohaux.lua"))()
